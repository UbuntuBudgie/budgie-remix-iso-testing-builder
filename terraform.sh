...
check_dependencies () {
   PACKAGES="dctrl-tools dpkg-dev genisoimage gfxboot-theme-ubuntu isolinux live-build python-minimal squashfs-tools syslinux  syslinux-utils syslinux-theme-budgie-remix-xenial zsync"
